    ...
    if (res.error) {
      ...
      setTimeout(() => {
        setMessages((prev) => [
          ...
          {
            id: Date.now() + 1,
            text: "Thanks for reaching out! A human will reply to your email shortly.",
            isUser: false,
          },
        ]);
      }, 1000);
              ...
              {[
                {
                  icon: <Mail size={20} />,
                  label: "Email",
                  value: "rangrezstencils@gmail.com",
                },
                {
                  icon: <Camera size={20} />,
                  label: "Instagram",
                  value: "@rangrez_henna_stencils",
                },
                {
                  icon: <MapPin size={20} />,
                  label: "Location",
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: "1.15rem", marginTop: "0.2rem" }}>
                      {item.value}
                    </p>
                  </div>
                </div>
            ...
            >
              {messages.length === 0 ? (
                ...
                >
                  ...
                  <p>
                    Send us a message and we'll reply to your email as soon as
                    possible.
                  </p>
                </div>
              ) : (
              ...
              >
                ...
                <div style={{ display: "flex", gap: "0.5rem" }}>
                  ...
                  <button
                    ...
                    style={{ padding: "0 1rem", minWidth: "50px" }}
                  >
                    <Send size={18} />
                  </button>
                </div>
